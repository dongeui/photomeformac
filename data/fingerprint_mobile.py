"""Direct-fingerprint MobileBackup missing files into media_files."""
import unicodedata
...
print(f"Missing MobileBackup files: {len(missing)}", flush=True)
...
for i, path_str in enumerate(missing, 1):
    ...
    try:
        ...
        kind = MediaKind.VIDEO if ext in (".mp4", ".mov", ".avi", ".mkv", ".m4v", ".3gp") else MediaKind.IMAGE
